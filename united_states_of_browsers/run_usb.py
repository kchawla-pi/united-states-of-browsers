...
def make_paths():
    venv_python_path = os.sys.executable
...
def make_commands_to_run_usb(
    venv_python_path, db_merge_module_path, usb_server_module_path
):
...
def launch_usb():
    ...
    db_merge_command, usb_server_command = make_commands_to_run_usb(
        venv_python_path,
