...
search_table_fields = ['rec_id', 'id', 'url', 'title', 'visit_count',
                       'last_visit', 'last_visit_readable', 'browser',
                       'profile', 'file',
                       'tablename']
...
if __name__ == '__main__':
    ...
    new_parent = Path(__file__).parents[2].joinpath('tests', 'data',
                                                    'browser_profiles_for_testing')
    print(new_parent)
