...
def test_browser_chrome_access_single_profile_file_table_with_timestamp(tests_root):
    ...
    assert check_records_unique_with_field(records=browser_profile1_records, field="id")
...
def test_browser_access_single_profile_file_table_without_timestamp(tests_root):
    ...
    table_profile1_records_ids = [record["url_id"] for record in table_profile1_records]
...
def test_browser_access_two_profiles_same_file_table(tests_root):
    ...
    table_records_urls = [record["url"] for record in profile_1_2_records_using_tables]
...
if __name__ == "__main__":  # pragme: no cover
    ...
    test_browser_chrome_access_single_profile_file_table_with_timestamp(tests_root)
